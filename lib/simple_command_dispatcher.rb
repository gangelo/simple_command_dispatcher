...
module SimpleCommandDispatcher
  ...
  class << self
    ...
    #    titleized.
    # @option options [Boolean] :titleize_class (false) determines whether or not class names should be titleized.
    # @option options [Boolean] :class_camelized (false) determines whether or not class names should be camelized.
    # @option options [Boolean] :titleize_module (false) determines whether or not module names should be titleized.
    ...
    #  SimpleCommandDispatcher.call(:Authenticate,
    ...
    #  SimpleCommandDispatcher.call(:Authenticate, ['Api::Auth::JazzMeUp', :V1],
